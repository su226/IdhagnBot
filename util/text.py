...
@overload
def paste(im: Image.Image, xy: tuple[int, int], content: Pango.Layout, *, color: tuple[int, int, int] = (0, 0, 0), anchor: Anchor = "lt") -> Image.Image: ...
@overload
def paste(im: Image.Image, xy: tuple[int, int], content: str, font: str, size: float, *, color: tuple[int, int, int] = (0, 0, 0), anchor: Anchor = "lt", box: tuple[int, int] | int | None = None, mode: Mode = 0, markup: bool = False) -> Image.Image: ...
