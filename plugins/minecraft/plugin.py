...
minecraft = (command.CommandBuilder("minecraft", "minecraft", "mc")
...
async def handle_minecraft(bot: Bot):
  ...
  await minecraft.finish(MessageSegment.image("base64://" + stats['favicon'].removeprefix("data:image/png;base64,")) + "\n".join(segments))
