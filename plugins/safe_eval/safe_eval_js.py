...
async def safe_eval(code: str, timeout: float, nproc: int, memory: int, output: int) -> tuple[bool, int, bytes, bytes]:
  proc = await asyncio.subprocess.create_subprocess_exec("bwrap",
    ...
    "--ro-bind", "/usr/lib/libcrypto.so.1.1", "/usr/lib/libcrypto.so.1.1",
    "--ro-bind", "/usr/lib/libssl.so.1.1", "/usr/lib/libssl.so.1.1",
    "--ro-bind", "/usr/lib/libicui18n.so.71", "/usr/lib/libicui18n.so.71",
    "--ro-bind", "/usr/lib/libicuuc.so.71", "/usr/lib/libicuuc.so.71",
    ...
    "--ro-bind", "/usr/lib/libicudata.so.71", "/usr/lib/libicudata.so.71",
