...
@wikipedia.handle()
async def handle_wikipedia(msg: Message = CommandArg(), state: T_State = State()):
...
async def got_choice(choice: str = ArgStr(), state = State()):
  choice = choice.strip()
  if choice == "退":
