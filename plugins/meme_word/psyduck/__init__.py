...
# RemapTransform((155, 100), ((0, 11), (154, 0), (161, 89), (20, 104))), (18, 42),  # noqa
# RemapTransform((155, 100), ((0, 9), (153, 0), (159, 89), (20, 101))), (15, 38),  # noqa
# RemapTransform((155, 100), ((0, 7), (148, 0), (156, 89), (21, 97))), (14, 23),  # noqa
# None,  # noqa
# RemapTransform((155, 100), ((10, 0), (143, 17), (124, 104), (0, 84))), (298, 18),  # noqa
# RemapTransform((155, 100), ((13, 0), (143, 27), (125, 113), (0, 83))), (298, 30),  # noqa
# RemapTransform((155, 100), ((13, 0), (143, 27), (125, 113), (0, 83))), (298, 26),  # noqa
# RemapTransform((155, 100), ((13, 0), (143, 27), (125, 113), (0, 83))), (298, 30),  # noqa
# RemapTransform((155, 100), ((13, 0), (143, 27), (125, 113), (0, 83))), (302, 20),  # noqa
# RemapTransform((155, 100), ((13, 0), (141, 23), (120, 102), (0, 82))), (300, 24),  # noqa
# RemapTransform((155, 100), ((13, 0), (140, 22), (118, 100), (0, 82))), (299, 22),  # noqa
# RemapTransform((155, 100), ((9, 0), (128, 16), (109, 89), (0, 80))), (303, 23),  # noqa
# None,  # noqa
# RemapTransform((155, 100), ((0, 13), (152, 0), (158, 89), (17, 109))), (35, 36),  # noqa
# RemapTransform((155, 100), ((0, 13), (152, 0), (158, 89), (17, 109))), (31, 29),  # noqa
# RemapTransform((155, 100), ((0, 17), (149, 0), (155, 90), (17, 120))), (45, 33),  # noqa
# RemapTransform((155, 100), ((0, 14), (152, 0), (156, 91), (17, 115))), (40, 27),  # noqa
# RemapTransform((155, 100), ((0, 12), (154, 0), (158, 90), (17, 109))), (35, 28),  # noqa
Data = Tuple[bool, imutil.Size, Tuple[imutil.Size, Image.Transform, imutil.PerspectiveData]]
TRANSFORMS: List[Optional[Data]] = [
  (False, (18, 42), ((161, 104), Image.Transform.PERSPECTIVE, (
  ...
  (False, (15, 38), ((159, 101), Image.Transform.PERSPECTIVE, (
  ...
  (False, (14, 23), ((156, 97), Image.Transform.PERSPECTIVE, (
  ...
  None,
  (True, (298, 18), ((143, 104), Image.Transform.PERSPECTIVE, (
  ...
  (True, (298, 30), ((143, 113), Image.Transform.PERSPECTIVE, (
  ...
  (True, (298, 26), ((143, 113), Image.Transform.PERSPECTIVE, (
    1.2180496357484907, 0.19077885861120172, -15.834645264728085, -0.23589081013623264,
    1.1357705673225826, 3.0665805317714274, 0.0004439859555503819, -0.00032101956391023
  ))),
  (True, (298, 30), ((143, 113), Image.Transform.PERSPECTIVE, (
  ...
  (True, (302, 20), ((143, 113), Image.Transform.PERSPECTIVE, (
    1.2180496357484907, 0.19077885861120172, -15.834645264728085, -0.23589081013623264,
    1.1357705673225826, 3.0665805317714274, 0.0004439859555503819, -0.00032101956391023
  ))),
  (True, (300, 24), ((141, 102), Image.Transform.PERSPECTIVE, (
  ...
  (True, (299, 22), ((140, 100), Image.Transform.PERSPECTIVE, (
  ...
  (True, (303, 23), ((128, 89), Image.Transform.PERSPECTIVE, (
  ...
  None,
  (False, (35, 36), ((158, 109), Image.Transform.PERSPECTIVE, (
  ...
  (False, (31, 29), ((158, 109), Image.Transform.PERSPECTIVE, (
    0.9099663448711841, -0.1611398735709377, 2.0948183564223495, 0.08107735568640635,
    0.9479813895641307, -12.323758064333685, -0.00061928256465016, -0.0006020817610338605
  ))),
  (False, (45, 33), ((155, 120), Image.Transform.PERSPECTIVE, (
  ...
  (False, (40, 27), ((156, 115), Image.Transform.PERSPECTIVE, (
  ...
  (False, (35, 28), ((158, 109), Image.Transform.PERSPECTIVE, (
...
async def handle_psyduck(args: Message = CommandArg()):
  ...
  def make() -> MessageSegment:
    ...
    for i, data in enumerate(TRANSFORMS):
      ...
      if data is not None:
        is_right, pos, transform = data
        text_im = (right_im if is_right else left_im).transform(*transform, imutil.resample())
