...
# RemapTransform((360, 260), ((33, 0), (375, 120), (333, 387), (0, 258)))  # noqa
TRANSFORM = (375, 387), Image.Transform.PERSPECTIVE, (
...
async def handle_sign(args: Message = CommandArg()):
  ...
  def make() -> MessageSegment:
    ...
    text_im = imutil.center_pad(text_im, 360, 260)
    text_im = text_im.transform(*TRANSFORM, imutil.resample())
