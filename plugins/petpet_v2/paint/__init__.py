...
matcher = (
  command.CommandBuilder("petpet_v2.paint", "像画")
  .category("petpet_v2")
  .shell(parser)
  .build())
...
async def handler(
  ...
  avatar = ImageOps.fit(avatar, (117, 135), util.scale_resample)
  avatar = avatar.rotate(4, util.resample, True)
  im.paste(avatar, (95, 107), avatar)
