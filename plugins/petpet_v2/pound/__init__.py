...
BOXES = [
  ...
  (150, 190, 105, 95), (148, 188, 106, 98), (146, 196, 110, 88),
  (145, 223, 112, 61), (145, 223, 112, 61)
]

parser = ArgumentParser("/捣", add_help=False)
...
matcher = nonebot.on_shell_command("捣", parser=parser)
matcher.__cmd__ = ["捣"]
