...
cat = (
  command.CommandBuilder("dog.cat", "喵", "喵喵", "meow")
  .brief("喵喵喵？喵喵。")
  .usage("喵，喵喵。" + WARN_STR)
  .build())
...
cat_gif = (
  command.CommandBuilder("dog.cat_gif", "喵呜")
  .brief("喵呜！喵——呜——")
...
dog = (
  command.CommandBuilder("dog.dog", "汪", "汪汪", "woof")
  .brief("汪？汪汪，汪汪汪！")
...
dog_gif = (
  command.CommandBuilder("dog.dog_gif", "汪嗷")
  .brief("汪，汪，汪嗷～")
