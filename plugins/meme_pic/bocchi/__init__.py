...
# RemapTransform((350, 400), ((54, 62), (353, 1), (379, 382), (1, 399)))  # noqa
# RemapTransform((350, 400), ((54, 61), (349, 1), (379, 381), (1, 398)))  # noqa
# RemapTransform((350, 400), ((54, 61), (349, 1), (379, 381), (1, 398)))  # noqa
# RemapTransform((350, 400), ((54, 61), (335, 1), (379, 381), (1, 398)))  # noqa
# RemapTransform((350, 400), ((54, 61), (335, 1), (370, 381), (1, 398)))  # noqa
# RemapTransform((350, 400), ((41, 59), (321, 1), (357, 379), (1, 396)))  # noqa
# RemapTransform((350, 400), ((41, 57), (315, 1), (357, 377), (1, 394)))  # noqa
# RemapTransform((350, 400), ((41, 56), (309, 1), (353, 380), (1, 393)))  # noqa
# RemapTransform((350, 400), ((41, 56), (314, 1), (353, 380), (1, 393)))  # noqa
# RemapTransform((350, 400), ((41, 50), (312, 1), (348, 367), (1, 387)))  # noqa
# RemapTransform((350, 400), ((35, 50), (306, 1), (342, 367), (1, 386)))  # noqa
Data = Tuple[imutil.Size, Tuple[imutil.Size, Image.Transform, imutil.PerspectiveData]]
TRANSFORMS: List[Data] = [
  ((146, 173), ((379, 399), Image.Transform.PERSPECTIVE, (
  ...
  ((146, 174), ((379, 398), Image.Transform.PERSPECTIVE, (
  ...
  ((152, 174), ((379, 398), Image.Transform.PERSPECTIVE, (
    1.5344695588304134, 0.24132607305049947, -97.58224663291313, 0.34672637150144936,
    1.704737993215485, -122.71224164722129, 0.0007191678985663559, 0.0009788476059334802
  ))),
  ((158, 167), ((379, 398), Image.Transform.PERSPECTIVE, (
  ...
  ((157, 149), ((370, 398), Image.Transform.PERSPECTIVE, (
  ...
  ((167, 108), ((357, 396), Image.Transform.PERSPECTIVE, (
  ...
  ((173, 69), ((357, 394), Image.Transform.PERSPECTIVE, (
  ...
  ((175, 43), ((353, 393), Image.Transform.PERSPECTIVE, (
  ...
  ((174, 30), ((353, 393), Image.Transform.PERSPECTIVE, (
  ...
  ((171, 18), ((348, 387), Image.Transform.PERSPECTIVE, (
  ...
  ((178, 14), ((342, 386), Image.Transform.PERSPECTIVE, (
